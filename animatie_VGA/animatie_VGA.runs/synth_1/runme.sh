...
HD_PWD='D:/PSN/animatie_VGA/animatie_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nexys4.tcl
